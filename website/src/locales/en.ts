...
export const en = {
    ...
    currentStatus: {
      body: [
        ...
        "Post-1.0 compatibility work is underway. The Home Assistant integration can calibrate a camera against a receiver, preview and save recommended defaults, expose saved defaults in diagnostics, show the latest recommendation on the receiver device, and report whether the installed receiver is current, degraded, legacy, or incompatible.",
      ],
